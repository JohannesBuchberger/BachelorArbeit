...
\abbildung{1\textwidth}{img/proc;SpeiseMain.png}{iref:SpeiseMain}{Top-Level-Prozess für die Restaurantbestellung (Eigengestaltung)}
...
\clearpage
\paragraphandnewline{Visualisierung des Prozessflusses}
\abbildung{1\textwidth}{img/proc;Selbstbedienungsprozess.png}{iref:Selbestbedienungsprozess}{Toplevel-Prozess für das Selbstbedienungsrestaurant (Eigengestaltung)}
...
\paragraphandnewline{Beteiligte Prozessrollen}
\paragraphandnewline{Visualisierung des Prozessflusses}
\abbildung{1\textwidth}{img/proc;Bestellprozess.png}{iref:Bestellprozess}{Bestellprozess (Eigengestaltung)}
...
\paragraphandnewline{Visualisierung des Prozessflusses}
\clearpage
\abbildung{1\textwidth}{img/proc;Zahlungsprozess.png}{iref:Zahlungsprozess}{Zahlungsprozess (Eigengestaltung)}
\abbildung{1\textwidth}{img/proc;Zahlungsvorbereitungsprozess.png}{iref:Zahlungsvorbereitungsprozess}{Zahlungsvorbereitungsprozess (Eigengestaltung)}

\paragraphandnewline{Beschreibung des Datenflusses}

\subsubsection{Zubereitungsprozess}
\clearpage
\abbildung{1\textwidth}{img/proc;Zubereitungsprozess.png}{iref:Zubereitungsprozess}{Zubereitungsprozess (Eigengestaltung)}

\subsubsection{Abholungsprozess}
\clearpage
\abbildung{1\textwidth}{img/proc;Abholungsprozess.png}{iref:Abholungsprozess}{Abholungsprozess (Eigengestaltung)}

\subsubsection{Zahlungsrückabwicklungsprozess}
\clearpage
\abbildung{1\textwidth}{img/proc;Zahlungsrückabwicklungsprozess.png}{iref:Zahlungsrückabwicklungsprozess}{Zahlungsrückabwicklungsprozess (Eigengestaltung)}
...
\clearpage
\paragraphandnewline{Visualisierung des Prozessflusses}
\abbildung{1\textwidth}{img/proc;SpeisekartenEditierProzess.png}{iref:Speisekarteneditierprozess}{Speisekarteneditierprozess (Eigengestaltung)}
...
\abbildung{1\textwidth}{img/uml;order_datenmodell.png}{iref:orderDatabase}{Order Datenbank (Eigengestaltung)}

\subsection{Architektur}
\abbildung{1\textwidth}{img/uml;Architekturdiagramm}{iref:architekturdiagramm}{Architekturdiagramm (Eigengestaltung)}
