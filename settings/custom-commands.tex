...
% ===========================================================================================
\newcommand{\figsource}[1]{\hfill{#1}} %command definition for sources in figures

\newcommand{\abbildung}[5]{% [width]{file}{ref-label}{visible-caption}{source]
  \begin{figure}[htbp]
    \centering
...
\newcommand{\abbildungsvg}[5]{% [width]{file}{ref-label}{visible-caption}{source}
  \begin{figure}[htbp]
    \centering
